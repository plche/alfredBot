public class AlfredTest {
    ...
    */
    public static void main(String[] args) {
        ...
        String testGuestGreetingS = alfredBot.guestGreeting("Beth Kane", "noche");
        String testGuestGreetingP = alfredBot.guestGreeting();
        ...
        String testYell = alfredBot.yellIfAngry("Angry", true);
        ...
        System.out.println(testGuestGreetingP);
